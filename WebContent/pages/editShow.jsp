		...
		<tr>
			...
			<td>
				<form action="../editShow" method="post">
					<p>Date: <input type="date" name="dateTime" placeholder="Select Date" required="required" value="<%=request.getParameter("date") %>" class="dateClass"></p>
					<p>Hrs: <input type="number" name="hours" min="7" max="23" required="required" value="<%=Integer.parseInt(request.getParameter("hrs")) %>"></p>
					<p>Min: <input type="number" name="min" min="00" max="59" required="required" value="<%=Integer.parseInt(request.getParameter("min")) %>"></p>
					...
					<input type="submit" value="Edit Show" name="edit"/>
